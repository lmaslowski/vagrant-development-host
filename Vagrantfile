...
Vagrant::Config.run do |config|
  ...
  config.vm.share_folder( "local.remind-about.com", "/home/local.remind-about.com", "/Users/pawelgraczyk/Workspaces/php/zf2/local.remind-about.com", :owner => "vagrant", :group => "vagrant", :create=> true)
